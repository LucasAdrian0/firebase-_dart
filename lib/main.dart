...
void main() async {
  ...
  //Plugin para verificar erros com  Firebase Crashlytics
  FlutterError.onError = FirebaseCrashlytics.instance.recordFlutterFatalError;

  //Plugin para FirebaseMessaging
  ...
  //Singleton da configuração remota
  ...
  //valores padrão para caso fique sem acesso a internet
